 ...
 */
final class Version20201130095344 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE links_realisation ADD realisation_id INT NOT NULL, ADD name_link VARCHAR(255) DEFAULT NULL, ADD link VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE links_realisation DROP realisation_id, DROP name_link, DROP link');
    }
}
